...
class SwedbankCurrencyRatesCsvParserTest extends FunSuite {
  ...
  test("SwedbankCurrencyRatesCsvParser.parse") {
    ...
    assert(parsedCurrencies.head == Currency("AED", "0.00000", "0.00000", "4.30500", "3.86750", date))
    assert(parsedCurrencies.last == Currency("ZAR", "0.00000", "0.00000", "16.62600", "14.93700", date))
  }
}
